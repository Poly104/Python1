...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",
            style={"color": "#503D36", "font-size": 24, "textAlign": "center"}),  # May include style for title
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        df = recession_data.groupby(["Vehicle_Type", "unemployment_rate"])["Automobile_Sales"].mean().reset_index()
        R_chart4 = dcc.Graph(figure=px.bar(df, x="Vehicle_Type", y="Automobile_Sales", color="unemployment_rate",
    ...
    # Yearly Statistic Report Plots
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(tma, x="Month", y="Automobile_Sales", title="Total Monthly Automobile sales"))
